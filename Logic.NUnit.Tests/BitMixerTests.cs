...
namespace ArrayHelper.NUnit.Tests
{
    ...
    class BitMixerTests { 
        ...
        public void InsertationByChars_TwoNumbersWithIndexesOfPositionsChange_ExpectedNumber(int numberA, int numberB, int iPosition, int jPosition, int expectedNumber)
        {
            //AAA Arrange in Args
            //Act
            var result = InsertionByChars(numberA, numberB, iPosition, jPosition);
            //Assert 
        ...
        [TestCase(15, -15, 4, 4, 31)]
        [TestCase(15, int.MaxValue, 3, 5, 63)]
        public void Insertation_TwoNumbersWithIndexesOfPositionsChange_ExpectedNumber(int numberA, int numberB, int iPosition, int jPosition, int expectedNumber)
        {
            //AAA Arrange in Args
            //Act
            var result = Insertion(numberA, numberB, iPosition, jPosition);
            //Assert 
            Assert.AreEqual(expectedNumber, result);
        }
